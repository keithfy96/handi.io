...
for serviceData in servicesData:
  ...
  tolog = 'N/A' if 'Servicing Units' not in service else service['Servicing Units']
  print(f'logged {tolog}')
  airtableServices.append({
    'serviceName': serviceName,
    'serviceUnit': 'N/A' if 'Servicing Units' not in service else service['Servicing Units'],
